...
namespace Hauntscope.Gameplay.Config
{
    ...
    public sealed class HudConfig
    {
        ...
        [SerializeField, Min(0f)] private float _surgeShake = 16f;
        ...
        // Reticle tremble in canvas pixels while the ghost thrashes in its last surge.
        public float SurgeShake => _surgeShake;
    }
}
